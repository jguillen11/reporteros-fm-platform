    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 sm:p-10">
            <div className="max-w-5xl mx-auto bg-white p-6 sm:p-10 rounded-xl shadow-2xl">
                ...
                <div className="mb-8 border-b pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <h1 className="text-2xl sm:text-4xl font-extrabold text-gray-900 leading-tight break-words">
                        Editando: {formData.title}
                    </h1>

                    <Link
                        to="/admin/dashboard"
                        className="self-start sm:self-auto text-sm sm:text-base font-medium text-gray-600 hover:text-blue-600 transition bg-gray-100 sm:bg-transparent px-3 py-1 sm:px-0 sm:py-0 rounded-md sm:rounded-none"
                    >
                        ← Volver al Dashboard
                    </Link>
                </div>
